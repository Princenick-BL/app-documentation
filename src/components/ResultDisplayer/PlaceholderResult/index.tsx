import { ModelResult } from '@/services/models'
import React from 'react'
import styles from './index.module.scss'
import Image from 'next/image'
import AI_Icon from '@/components/AI_Icon'

type Props = {
}

export default function PlaceholderResult({ }: Props) {
  return (
    <div className={styles.result}>
      ...
      <span>Evreything you need to create great things</span>
    </div>
  )
}